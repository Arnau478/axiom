...
pub fn init(options: InitOptions) !GraphicsContext {
...
pub fn deinit(gc: *const GraphicsContext) void {
    gc.device.destroyDevice(null);
    gc.instance.destroySurfaceKHR(gc.surface, null);
    gc.instance.destroyDebugUtilsMessengerEXT(gc.debug_messenger, null);
    gc.instance.destroyInstance(null);
